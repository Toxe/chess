...
TEST_CASE("perft/perft")
{
    SECTION("the board does not change")
    {
        ...
        const GameState game_state{fen.halfmove_clock, fen.fullmove_counter, fen.castling_ability, fen.en_passant_target_square};
    ...
    SECTION("example 1 (default starting position)")
    {
        ...
        const GameState game_state{0, 1, CastlingAbility{CastlingRight::white_king, CastlingRight::white_queen, CastlingRight::black_king, CastlingRight::black_queen}, std::nullopt};
        PerftDivide perft_divide;
